...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLinktoresourcePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Linktoresource feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLinktoresourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_linktoresource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_linktoresource_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__LINKTORESOURCE,
				 true,
				 false,
				 true,
				 null,
