...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (quantite=EInt resources=[Resources|EString] workdefinition=[WorkDefinition|EString])
	 */
	protected void sequence_RequeteDeRessource(ISerializationContext context, RequeteDeRessource semanticObject) {
		...
		feeder.accept(grammarAccess.getRequeteDeRessourceAccess().getQuantiteEIntParserRuleCall_3_0(), semanticObject.getQuantite());
		feeder.accept(grammarAccess.getRequeteDeRessourceAccess().getResourcesResourcesEStringParserRuleCall_5_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.REQUETE_DE_RESSOURCE__RESOURCES, false));
		feeder.accept(grammarAccess.getRequeteDeRessourceAccess().getWorkdefinitionWorkDefinitionEStringParserRuleCall_7_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.REQUETE_DE_RESSOURCE__WORKDEFINITION, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString quantite=EInt (linktoresource+=[RequeteDeRessource|EString] linktoresource+=[RequeteDeRessource|EString]*)?)
	 */
