...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Linktoresource</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__LINKTORESOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.ResourcesImpl <em>Resources</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.ResourcesImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getResources()
	 * @generated
	 */
	int RESOURCES = 5;
	 ...
	 * @ordered
	 */
	int RESOURCES__QUANTITE = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCES__LINKTORESOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCES__NAME = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESOURCES_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOURCES_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link simplepdl.impl.RequeteDeRessourceImpl <em>Requete De Ressource</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.RequeteDeRessourceImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getRequeteDeRessource()
	 * @generated
	 */
	int REQUETE_DE_RESSOURCE = 6;
	 ...
	 * @ordered
	 */
	int REQUETE_DE_RESSOURCE__QUANTITE = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int REQUETE_DE_RESSOURCE__RESOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int REQUETE_DE_RESSOURCE__WORKDEFINITION = PROCESS_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Requete De Ressource</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REQUETE_DE_RESSOURCE_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;

	/**
	 * The number of operations of the '<em>Requete De Ressource</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.WorkDefinition#getLinktoresource <em>Linktoresource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Linktoresource</em>'.
	 * @see simplepdl.WorkDefinition#getLinktoresource()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_Linktoresource();
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.Resources <em>Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Resources</em>'.
	 * @see simplepdl.Resources
	 * @generated
	 */
	EClass getResources();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Resources#getQuantite <em>Quantite</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantite</em>'.
	 * @see simplepdl.Resources#getQuantite()
	 * @see #getResources()
	 * @generated
	 */
	EAttribute getResources_Quantite();

	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Resources#getLinktoresource <em>Linktoresource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Linktoresource</em>'.
	 ...
	 * @generated
	 */
	EReference getResources_Linktoresource();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Resources#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see simplepdl.Resources#getName()
	 * @see #getResources()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.RequeteDeRessource <em>Requete De Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Requete De Ressource</em>'.
	 * @see simplepdl.RequeteDeRessource
	 * @generated
	 */
	EClass getRequeteDeRessource();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RequeteDeRessource#getQuantite <em>Quantite</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantite</em>'.
	 * @see simplepdl.RequeteDeRessource#getQuantite()
	 * @see #getRequeteDeRessource()
	 * @generated
	 */
	EAttribute getRequeteDeRessource_Quantite();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RequeteDeRessource#getResources <em>Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getRequeteDeRessource_Resources();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RequeteDeRessource#getWorkdefinition <em>Workdefinition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Linktoresource</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__LINKTORESOURCE = eINSTANCE.getWorkDefinition_Linktoresource();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.ResourcesImpl <em>Resources</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.ResourcesImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getResources()
		 ...
		 * @generated
		 */
		EAttribute RESOURCES__QUANTITE = eINSTANCE.getResources_Quantite();
		 ...
		 * @generated
		 */
		EReference RESOURCES__LINKTORESOURCE = eINSTANCE.getResources_Linktoresource();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.RequeteDeRessourceImpl <em>Requete De Ressource</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.RequeteDeRessourceImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getRequeteDeRessource()
		 * @generated
		 */
		EClass REQUETE_DE_RESSOURCE = eINSTANCE.getRequeteDeRessource();
		 ...
		 * @generated
		 */
		EAttribute REQUETE_DE_RESSOURCE__QUANTITE = eINSTANCE.getRequeteDeRessource_Quantite();
		 ...
		 * @generated
		 */
		EReference REQUETE_DE_RESSOURCE__RESOURCES = eINSTANCE.getRequeteDeRessource_Resources();
