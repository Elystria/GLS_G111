 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getLinktoresource <em>Linktoresource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<RequeteDeRessource> getLinktoresource() {
		if (linktoresource == null) {
			linktoresource = new EObjectWithInverseResolvingEList<RequeteDeRessource>(RequeteDeRessource.class, this, SimplepdlPackage.WORK_DEFINITION__LINKTORESOURCE, SimplepdlPackage.REQUETE_DE_RESSOURCE__WORKDEFINITION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINKTORESOURCE:
